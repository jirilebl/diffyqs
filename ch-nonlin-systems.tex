...
\begin{diffyfloatingfiguresimple}{1.45in}{1.75in}
\noindent
\inputpdft{mv-pend}
\end{diffyfloatingfiguresimple}
%For example,
...
derivative and linearizing.  We work similarly with nonlinear systems of
ODE\@.
...
\begin{diffyfloatingfiguresimple}{0.95in}{1.25in}
\noindent
