...
Three are 3 centers shown, one at the origin, one at (minus 2 pi,0)
ad one at (2 pi,0).  The arrows are winding clockwise around the centers.
...
On the right is plot for t between 0 and 40, where the graph of predators
...
while a trajectory starting just outside of the limit cycle goes around one
