...
were to make a loop one would have go against the arrows once one goes
...
is in tick red and prey in thin blue.  The predators start lower than prey.
The prey grow quickly at first reaching a peak when the predators start
growing, and then the prey goes down significantly.  Once the pray is
