...
the arrows in a diagonally down direction go towards the critical point
and in a diagonally upwards direction go away from the critical point.
...
rightwards until they leave the picture, never making it past x=1.}
...
picture of a saddle where along the line v=u the arrows point away from the
origin and along v=-u the arrows point towards the origin.  The lines v=u
and v=-u are drawn as trajectories.  In the picture divided by these lines,
...
A direction field plot in the xy-plane.
The arrows seem to be going around the origin countrclockwise, but not
...
take a detour around the origin.  Those that start above the y=-x
...
\begin{myfig}
\capstart
\diffyincludegraphics{width=3in}{width=4.5in}{nlin-ex813-new}{FIXMEALT}
...
\begin{myfig}
\capstart
\diffyincludegraphics{width=3in}{width=4.5in}{nlin-ex813}{FIXMEALT}
\caption{The phase portrait with few sample trajectories of 
...
\begin{myfig}
\capstart
\diffyincludegraphics{width=3in}{width=4.5in}{nlin-unstable-centerfig}{FIXMEALT}
...
\begin{myfig}
\capstart
\diffyincludegraphics{width=3in}{width=4.5in}{nlin-pend-phasediag}{FIXMEALT}
...
\diffyincludegraphics{width=6.24in}{width=9in}{nlin-T-vs-T0-abs-relerr}{FIXMEALT}
...
A diagram of the so-called Sierpinsky triangle composed of dots in
