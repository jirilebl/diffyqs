...
going 'through' the critical point at (1,0) making a loop, although if one
...
seem to be roughly zero along the x-axis.  The arrows above the
...
on the x-axis point rightward, on the y-axis point rightward.  In the first
...
A direction field plot in the xy-plane.
The arrows seem to be going around the origin counterclockwise, but not
