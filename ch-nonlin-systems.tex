...
%mbxENDIGNORE
%mbxlatex \diffyincludegraphics{width=6in}{width=9in}{nlin-1b-lin-00-01}
...
\capstart
%mbxSTARTIGNORE
\diffyincludegraphics{width=2.88in}{width=4.5in}{nlin-T-vs-T0-abs}
\quad
\diffyincludegraphics{width=3in}{width=4.5in}{nlin-T-vs-T0-relerr}
%mbxENDIGNORE
%mbxlatex \diffyincludegraphics{width=6in}{width=9in}{nlin-T-vs-T0-abs-relerr}
...
%mbxENDIGNORE
%mbxlatex \diffyincludegraphics{width=6in}{width=9in}{nlin-pred-prey-phase-graphs}
...
%mbxENDIGNORE
%mbxlatex \diffyincludegraphics{width=6in}{width=9in}{nlin-van-der-phase-plot1}
...
\quad
\diffyincludegraphics{width=2.9in}{width=4.5in}{nlin-duf-two-sols}
%mbxENDIGNORE
%mbxlatex \diffyincludegraphics{width=6in}{width=9in}{nlin-duf-two-traj-sols}
...
\quad
\diffyincludegraphics{width=2.9in}{width=4.5in}{nlin-strange2}
%mbxENDIGNORE
%mbxlatex \diffyincludegraphics{width=6in}{width=9in}{nlin-strange-strange2}
