...
very rounded rectangle.  It is roughly between minus 2 and 2 on the
...
By Poincar\'e--Bendixson, all these solutions are periodic.
...
roughly -3 to 3.  The plot is function which goes up and down many times
roughly at the same overall rhythm and the peaks and troughs are very roughly at
the same hight, but each peak has a very different shape with distinct
wiggles on each.}
...
The remaining 3 upright triangles are not filled, but each have an
