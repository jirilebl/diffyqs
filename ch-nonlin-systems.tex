...
\diffyincludegraphics{width=6.24in}{width=9in}{nlin-van-der-phase-plot1}{FIXMEALT}
...
\begin{myfig}
\capstart
\diffyincludegraphics{width=3in}{width=4.5in}{nlin-unstable-limit-cycle}{FIXMEALT}
...
\diffyincludegraphics{width=6.24in}{width=9in}{nlin-duf-two-traj-sols}{FIXMEALT}
...
\diffyincludegraphics{width=6.24in}{width=9in}{nlin-strange-strange2}{FIXMEALT}
...
\begin{myfig}
\capstart
\diffyincludegraphics{width=3in}{width=4.5in}{nlin-lorenz}{FIXMEALT}
