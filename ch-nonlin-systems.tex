...
\begin{enumerate}[a)]
\item $x'=x^2-y^2$, $y'=x^2+y^2-1$,
\item $x'=-y$, $y'=3x+yx^2$,
\item $x'=x^2+y$, $y'=y^2+x$.
\end{enumerate}
\end{exercise}
...
\begin{enumerate}[a)]
\item $x'=x+2y+x^2-y^2$, $y'=2y-x^2$
\item $x'=-y$, $y'=x-y^3$
\item $x'=ax+by+f(x,y)$, $y'=cx+dy+g(x,y)$, where
$f(0,0) = 0$,
...
\begin{enumerate}[a)]
\item Find the set of critical points.
\item Sketch a phase diagram and describe the behavior near the critical
point(s).
\item Find the linearization.  Is it helpful in understanding the system?
\end{enumerate}
\end{exercise}
...
Find the critical points and linearizations of the following systems.
\begin{enumerate}[a)]
\item $x'=\sin(\pi y)+(x-1)^2$, $y'=y^2-y$,
\item $x'=x+y+y^2$, $y'=x$,
\item $x'=(x-1)^2+y$, $y'=x^2+y$.
\end{enumerate}
\end{exercise}
\exsol{%
