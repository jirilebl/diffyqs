...
\capstart
\inputpdft{ps-conv}{%
A diagram of the number line with the points x0-rho, x0, and x0+rho marked.
The segment between x0-rho and x0+rho is shaded and marked with
'converges absolutely'.  The parts of the line below x0-rho and
above x0+rho is labeled 'diverges'.}
...
A plot of the sine function on the interval -10 to 10.
