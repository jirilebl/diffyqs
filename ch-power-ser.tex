...
\begin{myfig}
\capstart
\diffyincludegraphics{width=3in}{width=4.5in}{ps-sin}{FIXMEALT}
...
\begin{myfig}
\capstart
\diffyincludegraphics{width=3in}{width=4.5in}{ps-airy}{FIXMEALT}
...
\diffyincludegraphics{width=6.24in}{width=9in}{bessel-first-second}{FIXMEALT}
