...
At time 0, there are 100 bacteria, 10 seconds later there are 200.
...
The arch in Saint Louis is a so-called weighted catenary (upside down).
The formula the architects used:
\begin{equation*}
