...
\[
\text{practical resonance frequency }
\omega = \sqrt{\omega_0^2 - 2p^2} .
\]
\pause
If practical resonance occurs, its frequency $\omega$ is smaller than $\omega_0$.

\pause
For very small damping $c$,
the practical resonance frequency $\omega \approx \omega_0$.
