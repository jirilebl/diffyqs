...
is $u_1' y_1 + u_2' y_2 = 0$ and $u_1' y_1' + u_2' y_2' = f(x)$.  Then
integrate $u_1'$ and $u_2'$ to find $u_1$ and $u_2$, and you have your
particular solution $y = u_1 y_1 + u_2 y_2$.
We remark that if $y''$ has some coefficient that is not $1$, that is, if
the equation is $ay'' + by' + cy = f(x)$, you must divide the equation by
$a$ first.
