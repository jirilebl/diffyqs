...
A graph of the function for t from 0 to 20, which is a sinusoidal curve that
...
A plot for t between 0 and 30.  Two decaying exponential curves one starting it (0,1)
