...
\begin{enumerate}[a)]
\item Find a formula for the general solution
of $a x^2 y'' + b x y' + c y = 0$.  Hint: Try $y=x^r$ and find a formula for
$r$.
\item What happens when ${(b-a)}^2-4ac = 0$ or ${(b-a)}^2-4ac < 0$?
\end{enumerate}
\end{exercise}
...
$(1-x^2)y''-xy' + y = 0$.
\begin{enumerate}[a)]
\item Show that $y=x$ is a solution.
\item Use reduction of order to find a second linearly independent solution.
...
$y''-2xy' + 4y = 0$.
\begin{enumerate}[a)]
\item Show that $y=1-2x^2$ is a solution.  
\item Use reduction of order to find a second linearly independent solution.
\item Write down the general solution.
\end{enumerate}
\end{exercise}
...
\begin{mywrapfigsimp}{1.8in}{2.16in}
\diffypdfversion{\vspace*{-15pt}}
\noindent
\inputpdft{mv-pend-deriv}
%\diffypdfversion{\vspace*{24pt}}
\end{mywrapfigsimp}
...
\begin{enumerate}[a)]
\item Set up and find the general solution of the system.
\item Is the system underdamped, overdamped or critically damped?
\item If the system is not critically damped, find a $c$ that makes the system
critically damped.
\end{enumerate}
\end{exercise}
\end{samepage}
...
\begin{enumerate}[a)]
\item You count and find that the frequency is
\unit[0.8]{Hz} (cycles per second).  What is the mass?
\item Find a formula for the mass $m$
...
\begin{enumerate}[a)]
\item Find $k$ (spring constant) and $c$ (damping constant).
\item Find a formula for the mass in terms of the frequency in Hz.  \emph{Note that
there may be more than one possible mass for a given frequency.}
\item For an unknown object you measured \unit[0.2]{Hz}, what is the mass of the
...
constant voltage.
\begin{enumerate}[a)]
\item Set up the ODE equation for the current $I$.
\item Find the general solution.
\item Solve for $I(0) = 10$ and $I'(0) = 0$.
\end{enumerate}
\end{exercise}
\exsol{%
\\
...
\begin{enumerate}[a)]
\item Find $k$.
\item Find out how far does the spring compress when a
...
{\ }
\begin{enumerate}[a)]
\item Using variation of parameters find a particular solution of
$y''-2y'+y = e^x$.
\item Find a particular solution using undetermined
coefficients.
\item Are the two solutions you found the same?
...
{\ }
\begin{enumerate}[a)]
\item Find a particular solution to $y''+2y=e^x + x^3$.
\item Find the general solution.
\end{enumerate}
\end{exercise}
\exsol{%
