...
A grid of line segments with the slope given by y.  Overlaid
...
There are two lines giving solutions, one horizontal and one
...
towards a vertical line at temperature 22.}
...
Two plots plot in the xy-plane of a slope field with slopes y^2 over 3
...
A plot in the xy-plane of a slope field with slopes y^2/3
in the region where x is between minus 1 and 3 and y is between 0 and 3.
...
corner at (5,10) is drawn with a red dot marking the initial point
drawn at (1,2).}
\caption{Solution to 
...
between 0 and 3.  When t equals 0, the surface looks line a
