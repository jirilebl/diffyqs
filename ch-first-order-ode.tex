...
called the \emph{\myindex{convection equation}}.
...
We can see why $u_t + \alpha u_x = 0$ is called the
...
does not diffuse and is simply carried along.  In this setup, $x$ may be
position along the river, $t$ is the time, and $u(x,t)$ the concentration the
material at the position $x$ at time $t$.  See
