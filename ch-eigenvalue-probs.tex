...
The first function 1/x comes down from the top of the picture on the left
...
starts at zero when x=0 and then quickly curves up and leaves the picture
before pi/2 while crossing the graph of 1/x the first time.  After pi/2,
the tangent reappears from the bottom of the picture curves right and then
left before leaving the picture again before 3pi/2.  It crosses the graph of
1/x the second time in that interval.  After 3pi/2, it reappears from the
bottom and again goes up and crosses the graph of 1/x the third time.}
...
ranges from 0 to 5.  The function y is zero on 3 sides, that is at t=0
and when x=0 or x=1.  Inside its domain as t grows there is a bump going up
