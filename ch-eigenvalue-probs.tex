...
\begin{myfig}
\capstart
\diffyincludegraphics{width=3in}{width=4.5in}{sl-tanx1overx}{FIXMEALT}
...
\begin{myfig}
\capstart
\diffyincludegraphics{width=5in}{width=7.5in}{natfreq-forcedvib}{FIXMEALT}
...
\capstart
\inputpdft{sps-groundtemp}{FIXMEALT}
