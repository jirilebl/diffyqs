...
is transform, so we must also transform this condition
\begin{equation*}
Y(0) = 
...
\end{cases}
\end{equation*}
See \figrevref{lt:half-infinite-goo-river-wavefront} for a diagram of this
...
FIXME: the following needs lots of work:

FIXME

\begin{example}
Let us use the Laplace to find the D'Alembert solution for the 
...
\begin{align*}
& y_t = y_{xx}, \qquad 0 < x < 1, \enspace t > 0,\\
& y_x(0,t) = f(t), \\
& y(1,t) = 0, \\
& y(x,0) = 0 ,
\end{align*}
