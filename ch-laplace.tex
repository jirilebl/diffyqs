...
The function is zero for negative x and 1 for positive x.}
...
The function $f(t)$ is not periodic and defined piecewise; no problem for Laplace.
Imagine a
...
and stays at zero until t equals 1 when it curves upwards and follows a sightly
...
wish to solve for.
We have $x(t) = f(t) + (g * x)(t)$, so the question is if convolution is
